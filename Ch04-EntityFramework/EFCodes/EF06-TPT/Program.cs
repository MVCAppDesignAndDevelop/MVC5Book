...
namespace EF06_TPT
{
    ...
    public class CompanyDbContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<Product>().ToTable("ProductsModel")
                .Property(c => c.Id)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            
            modelBuilder.Entity<Camera>().ToTable("CameraModel");
            modelBuilder.Entity<SingleReflexCamera>().ToTable("SingleReflexCameraModel");
            modelBuilder.Entity<Lens>().ToTable("LensModel");
