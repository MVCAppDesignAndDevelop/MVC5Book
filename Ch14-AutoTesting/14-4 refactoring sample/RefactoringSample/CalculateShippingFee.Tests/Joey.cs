...
namespace SeleniumTests
{
    ...
    public class Joey
    {
        ...
        public void ChromeTest()
        {
            ...
            new SelectElement(driver.FindElement(By.Id("Company"))).SelectByText("黑貓");
            driver.FindElement(By.CssSelector("input[type=\"submit\"]")).Click();
            Assert.AreEqual("200", driver.FindElement(By.Id("fee")).Text);
            new SelectElement(driver.FindElement(By.Id("Company"))).SelectByText("新竹貨運");
            driver.FindElement(By.CssSelector("input[type=\"submit\"]")).Click();
            Assert.AreEqual("254.16", driver.FindElement(By.Id("fee")).Text);
            new SelectElement(driver.FindElement(By.Id("Company"))).SelectByText("郵局");
            driver.FindElement(By.CssSelector("input[type=\"submit\"]")).Click();
